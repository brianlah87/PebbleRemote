...
static TextLayer *tiny_message_box;
...
//BRIAN
static AppTimer *resetDisplayTimer;
static char dayString[11] = "";
static void resetDisplayTimerCallback(void *data){
...
static void update_days(struct tm *tick_time) {
  ...
  {
    case 0:
		  strncpy(dayString, "SUNDAY", sizeof(dayString));
      break;
    case 1:
		  strncpy(dayString, "MONDAY", sizeof(dayString));
      break;
    case 2:
		  strncpy(dayString, "TUESDAY", sizeof(dayString));
      break;
    case 3:
		  strncpy(dayString, "WEDNESDAY", sizeof(dayString));
      break;
    case 4:
		  strncpy(dayString, "THURSDAY", sizeof(dayString));
      break;
    case 5:
		  strncpy(dayString, "FRIDAY", sizeof(dayString));
      break;
    case 6:
...
static void sync_tuple_changed_callback(const uint32_t key, const Tuple * new_tuple, const Tuple * old_tuple, void *context) {
    ...
    switch (key) {
      ...
      if (settings.VibeMinutes > 0) {
				...
				text_layer_set_text(tiny_message_box, trim(label_text));
				layer_set_hidden(text_layer_get_layer(tiny_message_box), false);
			} else {
				layer_set_hidden(text_layer_get_layer(tiny_message_box), true);
			}
    */
			break;
...
static void up_click_handler(ClickRecognizerRef recognizer, void *context) {
  DictionaryIterator *iter;
	...
	dict_write_cstring(iter, 10, "http://home.brianlah.com:1338/?c=LTTTNTNN1T");  //key 10 is automationCommand
...
static void up_hold_handler(ClickRecognizerRef recognizer, void *context) {
  DictionaryIterator *iter;
	...
	app_message_outbox_begin(&iter);
	dict_write_cstring(iter, 10, "http://home.brianlah.com:1338/?c=L000N0NN1T");  //key 10 is automationCommand
...
static void select_click_handler(ClickRecognizerRef recognizer, void *context) {
  DictionaryIterator *iter;
	...
	app_message_outbox_begin(&iter);
	dict_write_cstring(iter, 10, "http://home.brianlah.com:1338/?c=LNNNNNN5NT");  //key 10 is automationCommand
...
static void select_hold_handler(ClickRecognizerRef recognizer, void *context) {
  DictionaryIterator *iter;
	...
	app_message_outbox_begin(&iter);
	dict_write_cstring(iter, 10, "http://home.brianlah.com:1338/?c=L00010NN1TA000HC170C");  //key 10 is automationCommand
...
static void down_click_handler(ClickRecognizerRef recognizer, void *context) {
  DictionaryIterator *iter;
	...
	app_message_outbox_begin(&iter);
	dict_write_cstring(iter, 10, "http://home.brianlah.com:1338/?c=LNNNTNNNNTAT00HC170C");  //key 10 is automationCommand
...
static void down_hold_handler(ClickRecognizerRef recognizer, void *context) {
  DictionaryIterator *iter;
	...
	app_message_outbox_begin(&iter);
	dict_write_cstring(iter, 10, "http://home.brianlah.com:1338/?c=LNNN1NNNNTA000HC170C");  //key 10 is automationCommand
...
static void init(void) {
  ...
  window_set_click_config_provider(window, click_config_provider);
    ...
    tiny_message_box = text_layer_create(GRect(0, 108, 144, 14));  //used to be 0, 117, 144, 14
    text_layer_set_background_color(tiny_message_box, GColorClear);
    text_layer_set_text_color(tiny_message_box, GColorWhite);
    text_layer_set_font(tiny_message_box, tiny_font);
...
*/
    ...
    text_layer_destroy(tiny_message_box);
    inverter_layer_destroy(inverter_layer);
